...
def execute_research_plan(plan: ResearchPlan, split_files: bool = False):
    """执行研究计划"""
...
示例:
  ...
  python -m autoresearch_v2 "研究主题"
    ...
    parser.add_argument("--split-files", "-s", action="store_true", help="拆分文件生成（推荐）")
    ...
    try:
        if use_auto_plan:
            ...
            execute_research_plan(plan, split_files=args.split_files)
